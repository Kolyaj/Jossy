...
module.exports.Parser = iclass.create({
    constructor: function() {
        ...
        this._registerDirective('imports', false, (builder) => {
            builder.importsHere();
        });
        ...
        this._registerDirective('layer', true, (builder, layer) => {
            builder.appendLayer(layer);
        });

        this._registerDirective('endlayer', false, (builder) => {
            builder.appendEndLayer();
        })
